...
<template>
  <div class="settings form-3 form-compact">
    ...
    >
      <div class="header-with-actions">
        ...
        <div class="header-actions-container">
          ...
          <div class="header-actions header-actions-group">
            <ActionButton
              data-test="save-device-group-button"
              :item="{}"
              :icon="faCheckDouble"
              icon-size="2x"
            ...
            />
            <ActionButton
              data-test="cancel-device-group-button"
              :item="{}"
              :icon="faXmark"
              icon-size="2x"
      ...
      <h2 class="secondary-heading playlist-heading" data-test="playlists-heading">Плейлисты</h2>
      <v-card class="mt-8">
        <v-data-table
