...
Таймауты для системных операций (применение настроек, перезагрузка, выключение) настраиваются переменными окружения или с помощью конфигурационного файла.
...
> **Примечание:** Значения должны быть в миллисекундах и представлять собой допустимые числа.
